...
/* ---- inlined: components/scent-before-after/styles.ts ---- */
...
/* ---- inlined: components/scent-before-after/types.ts ---- */
...
/* ---- inlined: components/scent-before-after/utils.ts ---- */
...
function resolveDirection(config: Record<string, unknown>): SplitDirection {
  const value = getRadioValue(config.sba_direction, 'vertical');
  return value === 'horizontal' ? 'horizontal' : 'vertical';
}

function parseSlides(raw: unknown): BeforeAfterSlide[] {
...
/* ---- inlined: components/scent-before-after/index.ts ---- */

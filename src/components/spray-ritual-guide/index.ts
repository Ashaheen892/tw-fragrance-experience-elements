...
/* ---- inlined: components/spray-ritual-guide/styles.ts ---- */
...
/* ---- inlined: components/spray-ritual-guide/types.ts ---- */
type RitualIntensity = 'light' | 'daily' | 'strong' | 'event' | 'custom';
...
/* ---- inlined: components/spray-ritual-guide/utils.ts ---- */
...
function resolveIntensity(raw: unknown): {
  key: RitualIntensity;
  label: string;
} {
...
function parseRituals(raw: unknown): SprayRitual[] {
...
function parseZones(raw: unknown): SprayZone[] {
  return normalizeCollection(raw)
    .map((row, index) => ({
      id: `zone-${index}`,
...
/* ---- inlined: components/spray-ritual-guide/index.ts ---- */

...
/* ---- inlined: components/interactive-notes-pyramid/styles.ts ---- */
...
/* ---- inlined: components/interactive-notes-pyramid/types.ts ---- */
...
/* ---- inlined: components/interactive-notes-pyramid/utils.ts ---- */
...
function resolveLayer(raw: unknown, fallback: NoteLayer = 'top'): NoteLayer {
...
function parsePyramidTiers(config: Record<string, unknown>): PyramidTier[] {
...
function hasPyramidContent(tiers: PyramidTier[]): boolean {
  return tiers.some((tier) => tier.notes.length > 0 || tier.label || tier.desc);
}

/* ---- inlined: components/interactive-notes-pyramid/index.ts ---- */

...
/* ---- inlined: components/scent-categories/styles.ts ---- */
...
/* ---- inlined: components/scent-categories/types.ts ---- */
type CategoryLayout = 'slider' | 'grid';
...
/* ---- inlined: components/scent-categories/utils.ts ---- */
...
function parseCategories(raw: unknown): ScentCategory[] {
...
/* ---- inlined: components/scent-categories/index.ts ---- */

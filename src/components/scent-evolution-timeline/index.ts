...
/* ---- inlined: components/scent-evolution-timeline/styles.ts ---- */
...
/* ---- inlined: components/scent-evolution-timeline/types.ts ---- */
...
/* ---- inlined: components/scent-evolution-timeline/utils.ts ---- */
function resolveLayout(config: Record<string, unknown>): TimelineLayout {
...
/* ---- inlined: components/scent-evolution-timeline/index.ts ---- */

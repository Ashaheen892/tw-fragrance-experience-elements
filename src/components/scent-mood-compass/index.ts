...
/* ---- inlined: components/scent-mood-compass/styles.ts ---- */
...
/* ---- inlined: components/scent-mood-compass/types.ts ---- */
...
/* ---- inlined: components/scent-mood-compass/utils.ts ---- */
function parseLabels(config: Record<string, unknown>): CompassLabels {
  return {
...
function parsePoints(raw: unknown): CompassPoint[] {
...
/* ---- inlined: components/scent-mood-compass/index.ts ---- */

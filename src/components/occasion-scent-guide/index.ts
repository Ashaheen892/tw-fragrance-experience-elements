...
/* ---- inlined: components/occasion-scent-guide/styles.ts ---- */
...
/* ---- inlined: components/occasion-scent-guide/types.ts ---- */
interface OccasionGuide {
  id: string;
  name: string;
  desc: string;
  scentProfile: string;
...
/* ---- inlined: components/occasion-scent-guide/utils.ts ---- */
function parseOccasions(raw: unknown): OccasionGuide[] {
...
/* ---- inlined: components/occasion-scent-guide/index.ts ---- */

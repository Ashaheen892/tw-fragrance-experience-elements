...
/* ---- inlined: components/perfume-quality-lab/styles.ts ---- */
...
/* ---- inlined: components/perfume-quality-lab/types.ts ---- */
...
/* ---- inlined: components/perfume-quality-lab/utils.ts ---- */
function resolveVideoEmbed(url: string): string {
...
function parseStations(raw: unknown): QualityStation[] {
...
/* ---- inlined: components/perfume-quality-lab/index.ts ---- */

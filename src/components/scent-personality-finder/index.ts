...
/* ---- inlined: components/scent-personality-finder/styles.ts ---- */
...
/* ---- inlined: components/scent-personality-finder/types.ts ---- */
interface ScentPersonality {
  id: string;
  name: string;
  desc: string;
  icon: string;
...
/* ---- inlined: components/scent-personality-finder/utils.ts ---- */
function parsePersonalities(raw: unknown): ScentPersonality[] {
...
/* ---- inlined: components/scent-personality-finder/index.ts ---- */

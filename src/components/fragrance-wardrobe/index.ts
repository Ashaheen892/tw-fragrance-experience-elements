...
/* ---- inlined: components/fragrance-wardrobe/styles.ts ---- */
...
/* ---- inlined: components/fragrance-wardrobe/types.ts ---- */
interface WardrobeSlot {
  id: string;
  name: string;
  desc: string;
  icon: string;
...
/* ---- inlined: components/fragrance-wardrobe/utils.ts ---- */
function parseSlots(raw: unknown): WardrobeSlot[] {
...
/* ---- inlined: components/fragrance-wardrobe/index.ts ---- */
/**

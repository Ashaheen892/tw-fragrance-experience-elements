...
/* ---- inlined: components/ingredient-stories/styles.ts ---- */
...
/* ---- inlined: components/ingredient-stories/types.ts ---- */
type IngredientLayout = 'grid' | 'list';

interface IngredientStory {
  id: string;
  name: string;
  shortTeaser: string;
  story: string;
...
/* ---- inlined: components/ingredient-stories/utils.ts ---- */
function resolveLayout(config: Record<string, unknown>): IngredientLayout {
  const value = getRadioValue(config.igs_layout, 'grid');
  return value === 'list' ? 'list' : 'grid';
}

function parseIngredients(raw: unknown): IngredientStory[] {
...
/* ---- inlined: components/ingredient-stories/index.ts ---- */

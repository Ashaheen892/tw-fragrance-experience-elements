...
/* ---- inlined: components/scent-scene/styles.ts ---- */
...
/* ---- inlined: components/scent-scene/types.ts ---- */
interface ScentScene {
  id: string;
  name: string;
  desc: string;
...
/* ---- inlined: components/scent-scene/utils.ts ---- */
function parseScenes(raw: unknown): ScentScene[] {
...
/* ---- inlined: components/scent-scene/index.ts ---- */

...
/* ---- inlined: components/fragrance-layering-lab/styles.ts ---- */
...
/* ---- inlined: components/fragrance-layering-lab/types.ts ---- */
interface LayeringRecipe {
  id: string;
  title: string;
  noteA: string;
  noteB: string;
...
/* ---- inlined: components/fragrance-layering-lab/utils.ts ---- */
function parseRecipes(raw: unknown): LayeringRecipe[] {
...
/* ---- inlined: components/fragrance-layering-lab/index.ts ---- */
